This is a real-time multiplayer game where you guess countries based on facts. It features a React/Next.js frontend with Socket.IO for real-time communication, backed by a Node.js/Express server.
